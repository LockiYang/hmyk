...
-- ----------------------------
INSERT INTO `hm_auth_rule` VALUES (1, 'file', 0, 'dashboard', '控制台', 'fa fa-dashboard', '', '', '用于展示当前系统中的统计数据、统计报表及重要实时数据', 1, 'addtabs', '', 'kzt', 'kongzhitai', 1491635035, 1724773575, 15, 'normal');
INSERT INTO `hm_auth_rule` VALUES (3, 'file', 92, 'category', '分类管理', 'fa fa-leaf', '', '', '分类类型请在常规管理->系统配置->字典配置中添加', 1, 'addtabs', '', 'flgl', 'fenleiguanli', 1491635035, 1724772258, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (4, 'file', 92, 'addon', '插件管理', 'fa fa-rocket', '', '', '可在线安装、卸载、禁用、启用、配置、升级插件，插件升级前请做好备份。', 1, 'addtabs', '', 'cjgl', 'chajianguanli', 1491635035, 1724772161, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (6, 'file', 92, 'general/config', '系统配置', 'fa fa-cog', '', '', '可以在此增改系统的变量和分组,也可以自定义分组和变量', 1, 'addtabs', '', 'xtpz', 'xitongpeizhi', 1491635035, 1724772251, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (7, 'file', 91, 'general/attachment', '附件管理', 'fa fa-file-image-o', '', '', '主要用于管理上传到服务器或第三方存储的数据', 1, 'addtabs', '', 'fjgl', 'fujianguanli', 1491635035, 1724773512, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (8, 'file', 91, 'general/profile', '个人资料', 'fa fa-user', '', '', '', 1, 'addtabs', '', 'grzl', 'gerenziliao', 1491635035, 1724773503, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (9, 'file', 93, 'auth/admin', '管理员', 'fa fa-user', '', '', '一个管理员可以有多个角色组,左侧的菜单根据管理员所拥有的权限进行生成', 1, 'addtabs', '', 'gly', 'guanliyuan', 1491635035, 1724772432, 0, 'normal');
...
INSERT INTO `hm_auth_rule` VALUES (11, 'file', 93, 'auth/group', '权限组', 'fa fa-group', '', '', '角色组可以有多个,角色有上下级层级关系,如果子角色有角色组和管理员的权限则可以派生属于自己组别的下级角色组或管理员', 1, 'addtabs', '', 'qxz', 'quanxianzu', 1491635035, 1724772440, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (12, 'file', 93, 'auth/rule', '菜单规则', 'fa fa-bars', '', '', '菜单规则通常对应一个控制器的方法,同时菜单栏数据也从规则中获取', 1, 'addtabs', '', 'cdgz', 'caidanguize', 1491635035, 1724772436, 0, 'normal');
...
INSERT INTO `hm_auth_rule` VALUES (66, 'file', 0, 'user', '用户管理', 'fa fa-user', '', '', '', 1, 'addtabs', '', 'yhgl', 'yonghuguanli', 1491635035, 1724773566, 13, 'normal');
INSERT INTO `hm_auth_rule` VALUES (67, 'file', 66, 'user/user', '用户列表', 'fa fa-male', '', '', '', 1, 'addtabs', '', 'yhlb', 'yonghuliebiao', 1491635035, 1724773496, 0, 'normal');
...
INSERT INTO `hm_auth_rule` VALUES (85, 'file', 0, 'goods', '商品管理', 'fa fa-shopping-cart', '', '', '', 1, 'addtabs', '', 'spgl', 'shangpinguanli', 1678965834, 1724773561, 12, 'normal');
INSERT INTO `hm_auth_rule` VALUES (86, 'file', 0, 'blog', '博客管理', 'fa fa-book', '', '', '', 1, 'addtabs', '', 'bkgl', 'bokeguanli', 1678965845, 1724773557, 11, 'normal');
INSERT INTO `hm_auth_rule` VALUES (87, 'file', 85, 'goods/category', '商品分类', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'spfl', 'shangpinfenlei', 1678965897, 1724773077, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (88, 'file', 85, 'goods/goods', '商品列表', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'splb', 'shangpinliebiao', 1678965921, 1724773292, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (89, 'file', 86, 'blog/category', '文章分类', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'wzfl', 'wenzhangfenlei', 1678965942, 1724773692, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (90, 'file', 86, 'blog/blog', '文章列表', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'wzlb', 'wenzhangliebiao', 1678965971, 1724773826, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (91, 'file', 0, 'general', '常规管理', 'fa fa-cogs', '', '', '', 1, 'addtabs', '', 'cggl', 'changguiguanli', 1678966054, 1724773571, 14, 'normal');
INSERT INTO `hm_auth_rule` VALUES (92, 'file', 0, 'develop', '开发专用', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'kfzy', 'kaifazhuanyong', 1678966151, 1724772132, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (93, 'file', 0, 'auth', '权限管理', 'fa fa-windows', '', '', '', 1, 'addtabs', '', 'qxgl', 'quanxianguanli', 1678966732, 1724772421, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (94, 'file', 0, 'finance', '财务管理', 'fa fa-bookmark', '', '', '', 1, 'addtabs', '', 'cwgl', 'caiwuguanli', 1678967013, 1724773554, 10, 'normal');
INSERT INTO `hm_auth_rule` VALUES (95, 'file', 94, 'finance/order/goods/index', '商品订单', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'spdd', 'shangpindingdan', 1678967186, 1724773975, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (97, 'file', 66, 'user/agency', '代理等级', 'fa fa-trello', '', '', '', 1, 'addtabs', '', 'dldj', 'dailidengji', 1678967382, 1724772765, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (98, 'file', 0, 'merchant', '分站管理', 'fa fa-window-restore', '', '', '', 1, 'addtabs', '', 'fzgl', 'fenzhanguanli', 1678967436, 1724773548, 9, 'normal');
...
INSERT INTO `hm_auth_rule` VALUES (104, 'file', 0, 'plugin/market/index', '插件管理', 'fa fa-plug', '', '', '', 1, 'addtabs', '', 'cjgl', 'chajianguanli', 1678968191, 1724772493, 1, 'normal');
INSERT INTO `hm_auth_rule` VALUES (107, 'file', 94, 'finance/order/recharge/index', '充值订单', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'czdd', 'chongzhidingdan', 1679032117, 1724773529, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (108, 'file', 94, 'finance/order/agency/index', '升级代理', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'sjdl', 'shengjidaili', 1679035487, 1724773534, 0, 'normal');
...
INSERT INTO `hm_auth_rule` VALUES (113, 'file', 94, 'finance/order/cashout/index', '提现订单', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'txdd', 'tixiandingdan', 1680349243, 1724773537, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (114, 'file', 91, 'system/index', '系统配置', 'fa fa-cog', '', '', '', 1, 'addtabs', '', 'xtpz', 'xitongpeizhi', 1680441716, 1724773508, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (115, 'file', 97, 'user/agency/index', '查看', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'zk', 'zhakan', 1724772801, 1724772828, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (116, 'file', 97, 'user/agency/add', '添加', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'tj', 'tianjia', 1724772906, 1724772927, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (117, 'file', 97, 'user/agency/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'bj', 'bianji', 1724772958, 1724772958, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (118, 'file', 97, 'user/agency/del', '删除', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'sc', 'shanchu', 1724772974, 1724772974, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (119, 'file', 87, 'goods/category/index', '查看', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'zk', 'zhakan', 1724773107, 1724773107, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (120, 'file', 87, 'goods/category/add', '添加', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'tj', 'tianjia', 1724773126, 1724773126, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (121, 'file', 87, 'goods/category/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'bj', 'bianji', 1724773140, 1724773140, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (122, 'file', 87, 'goods/category/del', '删除', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'sc', 'shanchu', 1724773155, 1724773155, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (123, 'file', 88, 'goods/goods/index', '查看', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'zk', 'zhakan', 1724773311, 1724773311, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (124, 'file', 88, 'goods/goods/add', '添加', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'tj', 'tianjia', 1724773328, 1724773328, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (125, 'file', 88, 'goods/goods/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'bj', 'bianji', 1724773349, 1724773349, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (126, 'file', 88, 'goods/goods/del', '删除', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'sc', 'shanchu', 1724773366, 1724773366, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (127, 'file', 88, 'goods/goods/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'plgx', 'pilianggengxin', 1724773381, 1724773381, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (128, 'file', 88, 'goods/stock/index', '查看库存', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'zkkc', 'zhakankucun', 1724773439, 1724773439, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (129, 'file', 88, 'goods/stock/add', '添加库存', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'tjkc', 'tianjiakucun', 1724773469, 1724773469, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (130, 'file', 88, 'goods/stock/del', '删除库存', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'sckc', 'shanchukucun', 1724773486, 1724773486, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (131, 'file', 89, 'blog/category/index', '查看', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'zk', 'zhakan', 1724773708, 1724773708, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (132, 'file', 89, 'blog/category/add', '添加', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'tj', 'tianjia', 1724773725, 1724773725, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (133, 'file', 89, 'blog/category/del', '删除', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'sc', 'shanchu', 1724773752, 1724773752, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (134, 'file', 89, 'blog/category/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'bj', 'bianji', 1724773767, 1724773767, 0, 'normal');
INSERT INTO `hm_auth_rule` VALUES (135, 'file', 90, 'blog/blog/index', '查看', 'fa fa-circle-o', '', '', '', 0, 'addtabs', '', 'zk', 'zhakan', 1724773841, 1724773841, 0, 'normal');
